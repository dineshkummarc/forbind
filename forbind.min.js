...
});var lastChild;if(typeof this.document!=="undefined"){var scripts=document.getElementsByTagName("script");lastChild=scripts[scripts.length-1];if(lastChild.nodeName==="SCRIPT")lastChild.getAttribute("src").replace(/apikey=(.+?)\b/,function(n,apikey){forbind.apikey=apikey})}if(typeof exports!=="undefined")exports.forbind=forbind;else window.forbind=forbind})("forbind.net",80);
